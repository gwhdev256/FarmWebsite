    ...
    return (
        <div>
            ...
            <div className="home-hay-info">
                <img src={bale} alt="home-hay" className="hay-pic-1"/>
            ...
            <div className="home-trailer-info">
                ...
                <img src={trailer2} alt="home-trailer" className="trailer-pic-2"/>
            </div>
            <div className="home-honey-info">
                <img src={honey} alt="home-honey" className="honey-pic-1"/>
